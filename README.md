...
````
bash <(curl -Ls https://raw.githubusercontent.com/Eaglesec/x-ui-en/master/install.sh)
````

## Manual install & upgrade

1. First download the latest compressed package from https://github.com/Eaglesec/x-ui-en/releases, generally choose `amd64` architecture
...
[![Stargazers over time](https://starchart.cc/Eaglesec/x-ui-en.svg)](https://starchart.cc/vaxilu/x-ui)